...
#define STABS_CURRENT_FILE(name) STABS_CURRENT_FILE1(#name)

#define STABS_CURRENT_FILE1(name) 1 : .stabs name, 100, 0, 0, 1b;

#define STABS_FUN_END(name) 1 : .stabs "", 36, 0, 0, 1b - name;
