...
#define DBG_TAB                                                                \
  ...
  , {"temp", DBG_TEMP, _NORMAL_}, {"print", DBG_PRINT, _NORMAL_},              \
      {"test", DBG_TEST, _RED_}, {"testpass", DBG_TESTPASS, _GREEN_},          \
      ...
      {"s5fs", DBG_S5FS, _BRED_}, {"pframe", DBG_PFRAME, _BMAGENTA_}, /* VM */ \
      ...
      {"user", DBG_USER, _BYELLOW_}, /* Note this MUST be last or the color    \
                                        code will break */ /* Also note that   \
                                                              the color        \
                                                              specified here   \
                                                              is effectively   \
                                                              the "default" */ \
 ...
 * about
 * some data structure. Functions implementing this interface should fill buf
 * with
 ...
 * information then only size characters will be writen and size will be
 * returned.
